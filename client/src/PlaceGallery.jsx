...
export default function PlaceGallery({place}) {
  ...
  return (
    <div className="relative">
      <div className="grid gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden"> {/*1st col is big and 2nd is small*/}
        <div>
          {/*  */}
          {place.photos?.[0] && (
            <div>
              {/* when we click on the photo we see all photoes of a places */}
